...
export default function Header() {
  ...
  return (
    <header className="bg-terminal-surface border-b border-terminal px-4 py-2 flex items-center justify-between flex-shrink-0 z-20">
      {/* Left: logo + nav */}
      <div className="flex items-center gap-6">
        ...
        <nav className="flex items-center gap-4 text-xs text-terminal-dim font-mono">
          <button
          ...
          <span className="text-terminal-dim">MIDDLE EAST / IRAN</span>
        </nav>
      </div>
      ...
      <div className="flex items-center gap-5 text-xs font-mono">
        ...
        <div className="flex items-center gap-2 text-terminal-dim">
          <span className="text-terminal-dim/60">UTC</span>
